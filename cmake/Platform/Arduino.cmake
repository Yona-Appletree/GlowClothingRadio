...
function(get_arduino_flags COMPILE_FLAGS_VAR LINK_FLAGS_VAR BOARD_ID MANUAL)
    ...
    # Handle platform:core references
    string(REGEX REPLACE ".*:(.*)" "\\1" BOARD_CORE ${BOARD_CORE})
...
function(setup_arduino_core VAR_NAME BOARD_ID)
    ...
    # Handle platform:core references by removing the platform indicator. All platforms cores are merged together here.
    string(REGEX REPLACE ".*:(.*)" "\\1" BOARD_CORE ${BOARD_CORE})
